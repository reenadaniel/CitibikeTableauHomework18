...
Congratulations on your new job! As the new lead analyst for the [New York Citi Bike](https://en.wikipedia.org/wiki/Citi_Bike) The Citi Bike ride sharing program is the largest bike sharing program in the Unites States, This application is for the program by providinf reports for city officials looking to publicize and improve the city program.
